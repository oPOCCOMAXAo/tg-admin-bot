...
type MessageInfo struct {
	...
	Time int64 `gorm:"column:time;not null;index:search_idx_v2"`
	...
	UserID int64 `gorm:"column:user_id;not null;default:0;index:search_idx_v2"`
	// tg sender chat id. It is a chat which sent the message, premium feature.
	SenderChatID  int64  `gorm:"column:sender_chat_id;not null;default:0;index:search_idx_v2"`
